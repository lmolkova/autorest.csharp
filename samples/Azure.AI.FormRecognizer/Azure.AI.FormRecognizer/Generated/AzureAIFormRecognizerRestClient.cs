...
namespace Azure.AI.FormRecognizer
{
    internal partial class AzureAIFormRecognizerRestClient
    {
        ...
        internal HttpMessage CreateAnalyzeBusinessCardAsyncRequest(ContentType contentType, Stream fileStream, bool? includeTextDetails, string locale)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="fileStream"/> is null. </exception>
        public async Task<ResponseWithHeaders<AzureAIFormRecognizerAnalyzeBusinessCardAsyncHeaders>> AnalyzeBusinessCardAsyncAsync(ContentType contentType, Stream fileStream, bool? includeTextDetails = null, string locale = null, CancellationToken cancellationToken = default)
        {
            if (fileStream == null)
            {
                throw new ArgumentNullException(nameof(fileStream));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="fileStream"/> is null. </exception>
        public ResponseWithHeaders<AzureAIFormRecognizerAnalyzeBusinessCardAsyncHeaders> AnalyzeBusinessCardAsync(ContentType contentType, Stream fileStream, bool? includeTextDetails = null, string locale = null, CancellationToken cancellationToken = default)
        {
            if (fileStream == null)
            {
                throw new ArgumentNullException(nameof(fileStream));
        ...
        internal HttpMessage CreateAnalyzeInvoiceAsyncRequest(ContentType contentType, Stream fileStream, bool? includeTextDetails, string locale)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="fileStream"> .json, .pdf, .jpg, .png or .tiff type file stream. </param>
        /// <param name="includeTextDetails"> Include text lines and element references in the result. </param>
        /// <param name="locale"> Locale of the invoice. Supported locales include: en-AU, en-CA, en-GB, en-IN, en-US(default). </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="fileStream"/> is null. </exception>
        public async Task<ResponseWithHeaders<AzureAIFormRecognizerAnalyzeInvoiceAsyncHeaders>> AnalyzeInvoiceAsyncAsync(ContentType contentType, Stream fileStream, bool? includeTextDetails = null, string locale = null, CancellationToken cancellationToken = default)
        {
            if (fileStream == null)
            {
                throw new ArgumentNullException(nameof(fileStream));
            ...
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            var headers = new AzureAIFormRecognizerAnalyzeInvoiceAsyncHeaders(message.Response);
            switch (message.Response.Status)
            {
                case 202:
                    return ResponseWithHeaders.FromValue(headers, message.Response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="fileStream"/> is null. </exception>
        public ResponseWithHeaders<AzureAIFormRecognizerAnalyzeInvoiceAsyncHeaders> AnalyzeInvoiceAsync(ContentType contentType, Stream fileStream, bool? includeTextDetails = null, string locale = null, CancellationToken cancellationToken = default)
        {
            if (fileStream == null)
            {
                throw new ArgumentNullException(nameof(fileStream));
        ...
        internal HttpMessage CreateAnalyzeInvoiceAsyncRequest(bool? includeTextDetails, string locale, SourcePath fileStream)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="fileStream"> .json, .pdf, .jpg, .png or .tiff type file stream. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<ResponseWithHeaders<AzureAIFormRecognizerAnalyzeInvoiceAsyncHeaders>> AnalyzeInvoiceAsyncAsync(bool? includeTextDetails = null, string locale = null, SourcePath fileStream = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="fileStream"> .json, .pdf, .jpg, .png or .tiff type file stream. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<AzureAIFormRecognizerAnalyzeInvoiceAsyncHeaders> AnalyzeInvoiceAsync(bool? includeTextDetails = null, string locale = null, SourcePath fileStream = null, CancellationToken cancellationToken = default)
        {
            using var message = CreateAnalyzeInvoiceAsyncRequest(includeTextDetails, locale, fileStream);
            _pipeline.Send(message, cancellationToken);
            var headers = new AzureAIFormRecognizerAnalyzeInvoiceAsyncHeaders(message.Response);
        ...
        internal HttpMessage CreateAnalyzeReceiptAsyncRequest(ContentType contentType, Stream fileStream, bool? includeTextDetails, string locale)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="fileStream"/> is null. </exception>
        public async Task<ResponseWithHeaders<AzureAIFormRecognizerAnalyzeReceiptAsyncHeaders>> AnalyzeReceiptAsyncAsync(ContentType contentType, Stream fileStream, bool? includeTextDetails = null, string locale = null, CancellationToken cancellationToken = default)
        {
            if (fileStream == null)
            {
                throw new ArgumentNullException(nameof(fileStream));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="fileStream"/> is null. </exception>
        public ResponseWithHeaders<AzureAIFormRecognizerAnalyzeReceiptAsyncHeaders> AnalyzeReceiptAsync(ContentType contentType, Stream fileStream, bool? includeTextDetails = null, string locale = null, CancellationToken cancellationToken = default)
        {
            if (fileStream == null)
            {
                throw new ArgumentNullException(nameof(fileStream));
        ...
        internal HttpMessage CreateAnalyzeLayoutAsyncRequest(ContentType1 contentType, Stream fileStream, IEnumerable<string> pageRange)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
            ...
            if (pageRange != null)
            {
                uri.AppendQueryDelimited("pageRange", pageRange, ",", true);
            }
            request.Uri = uri;
            request.Headers.Add("Content-Type", contentType.ToSerialString());
            request.Headers.Add("Accept", "application/json");
        ...
        /// <param name="contentType"> Upload file type. </param>
        /// <param name="fileStream"> .json, .pdf, .jpg, .png or .tiff type file stream. </param>
        /// <param name="pageRange"> Specify page number or range of page numbers to process, e.g: 1, 5, 7, 9-10. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="fileStream"/> is null. </exception>
        public async Task<ResponseWithHeaders<AzureAIFormRecognizerAnalyzeLayoutAsyncHeaders>> AnalyzeLayoutAsyncAsync(ContentType1 contentType, Stream fileStream, IEnumerable<string> pageRange = null, CancellationToken cancellationToken = default)
        {
            if (fileStream == null)
            {
                throw new ArgumentNullException(nameof(fileStream));
            ...
            using var message = CreateAnalyzeLayoutAsyncRequest(contentType, fileStream, pageRange);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="fileStream"/> is null. </exception>
        public ResponseWithHeaders<AzureAIFormRecognizerAnalyzeLayoutAsyncHeaders> AnalyzeLayoutAsync(ContentType1 contentType, Stream fileStream, IEnumerable<string> pageRange = null, CancellationToken cancellationToken = default)
        {
            if (fileStream == null)
            {
                throw new ArgumentNullException(nameof(fileStream));
        ...
        internal HttpMessage CreateAnalyzeLayoutAsyncRequest(IEnumerable<string> pageRange, SourcePath fileStream)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="fileStream"> .json, .pdf, .jpg, .png or .tiff type file stream. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<ResponseWithHeaders<AzureAIFormRecognizerAnalyzeLayoutAsyncHeaders>> AnalyzeLayoutAsyncAsync(IEnumerable<string> pageRange = null, SourcePath fileStream = null, CancellationToken cancellationToken = default)
        {
            using var message = CreateAnalyzeLayoutAsyncRequest(pageRange, fileStream);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            var headers = new AzureAIFormRecognizerAnalyzeLayoutAsyncHeaders(message.Response);
            switch (message.Response.Status)
            {
        ...
        /// <param name="fileStream"> .json, .pdf, .jpg, .png or .tiff type file stream. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<AzureAIFormRecognizerAnalyzeLayoutAsyncHeaders> AnalyzeLayoutAsync(IEnumerable<string> pageRange = null, SourcePath fileStream = null, CancellationToken cancellationToken = default)
        {
            using var message = CreateAnalyzeLayoutAsyncRequest(pageRange, fileStream);
            _pipeline.Send(message, cancellationToken);
            var headers = new AzureAIFormRecognizerAnalyzeLayoutAsyncHeaders(message.Response);
