...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    public partial class TrainResult
    {
        ...
        internal TrainResult(IReadOnlyList<TrainingDocumentInfo> trainingDocuments, IReadOnlyList<FormFieldsReport> fields, float? averageModelAccuracy, Guid? modelId, IReadOnlyList<ErrorInformation> errors)
        {
