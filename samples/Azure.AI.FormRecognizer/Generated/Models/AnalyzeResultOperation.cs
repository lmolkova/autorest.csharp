...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    public partial class AnalyzeResultOperation
    {
        ...
        internal AnalyzeResultOperation(AnalyzeResultOperationStatus status, DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, Error error, AnalyzeResult analyzeResult)
        {
            Status = status;
            CreatedDateTime = createdDateTime;
            LastUpdatedDateTime = lastUpdatedDateTime;
