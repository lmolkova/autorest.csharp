...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    public partial class DocumentPage
    {
        ...
        internal DocumentPage(int pageNumber, float angle, float width, float height, LengthUnit unit, IEnumerable<DocumentSpan> spans, IEnumerable<DocumentWord> words, IEnumerable<DocumentLine> lines)
        {
            if (spans == null)
            {
