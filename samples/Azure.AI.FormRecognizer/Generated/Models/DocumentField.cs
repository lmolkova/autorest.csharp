...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    public partial class DocumentField
    {
        ...
        /// <summary> 3-letter currency code value (ISO 4217). </summary>
        public string ValueCurrency { get; }
