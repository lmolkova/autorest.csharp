...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    public partial class Document
    {
        ...
        internal Document(string docType, IEnumerable<DocumentSpan> spans, IReadOnlyDictionary<string, DocumentField> fields, float confidence)
        {
            if (docType == null)
            {
        ...
        /// <param name="fields"> Dictionary of named field values. </param>
        /// <param name="confidence"> Confidence of correctly extracting the document. </param>
        internal Document(string docType, IReadOnlyList<BoundingRegion> boundingRegions, IReadOnlyList<DocumentSpan> spans, IReadOnlyDictionary<string, DocumentField> fields, float confidence)
        {
            DocType = docType;
