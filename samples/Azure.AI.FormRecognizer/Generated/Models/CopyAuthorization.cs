...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    public partial class CopyAuthorization
    {
        ...
        public CopyAuthorization(string targetResourceId, string targetResourceRegion, string targetModelId, string targetModelLocation, string accessToken, DateTimeOffset expirationDateTime)
        {
