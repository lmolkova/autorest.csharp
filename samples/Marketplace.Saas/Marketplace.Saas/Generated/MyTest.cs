...
using Marketplace.Saas.Models;

namespace Marketplace.Saas
{
    /// <summary> The MyTest service client. </summary>
    public partial class MyTest
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly HttpPipeline _pipeline;
        internal MyTestRestOperations RestClient { get; }
        /// <summary> Initializes a new instance of MyTest for mocking. </summary>
        protected MyTest()
        {
        }
        /// <summary> Initializes a new instance of MyTest. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="endpoint"> server parameter. </param>
        /// <param name="apiVersion"> Api Version. </param>
        internal MyTest(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint = null, string apiVersion = "2018-08-31")
        {
            RestClient = new MyTestRestOperations(clientDiagnostics, pipeline, endpoint, apiVersion);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("MyTest.Resolve");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("MyTest.GetSubscription");
            scope.Start();
            try
            {
        ...
        /// <param name="correlationId"> A unique string value for operation on the client. This parameter correlates all events from client operation with events on the server side. If this value isn&apos;t provided, one will be generated and provided in the response headers. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response> UpdateSubscriptionAsync(Guid subscriptionId, SubscriberPlan body, Guid? requestId = null, Guid? correlationId = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("MyTest.UpdateSubscription");
            scope.Start();
            try
            {
                return (await RestClient.UpdateSubscriptionAsync(subscriptionId, body, requestId, correlationId, cancellationToken).ConfigureAwait(false)).GetRawResponse();
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="correlationId"> A unique string value for operation on the client. This parameter correlates all events from client operation with events on the server side. If this value isn&apos;t provided, one will be generated and provided in the response headers. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response UpdateSubscription(Guid subscriptionId, SubscriberPlan body, Guid? requestId = null, Guid? correlationId = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("MyTest.UpdateSubscription");
            scope.Start();
            try
            {
                return RestClient.UpdateSubscription(subscriptionId, body, requestId, correlationId, cancellationToken).GetRawResponse();
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="correlationId"> A unique string value for operation on the client. This parameter correlates all events from client operation with events on the server side. If this value isn&apos;t provided, one will be generated and provided in the response headers. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response> DeleteSubscriptionAsync(Guid subscriptionId, Guid? requestId = null, Guid? correlationId = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("MyTest.DeleteSubscription");
            scope.Start();
            try
            {
                return (await RestClient.DeleteSubscriptionAsync(subscriptionId, requestId, correlationId, cancellationToken).ConfigureAwait(false)).GetRawResponse();
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="correlationId"> A unique string value for operation on the client. This parameter correlates all events from client operation with events on the server side. If this value isn&apos;t provided, one will be generated and provided in the response headers. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response DeleteSubscription(Guid subscriptionId, Guid? requestId = null, Guid? correlationId = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("MyTest.DeleteSubscription");
            scope.Start();
            try
            {
                return RestClient.DeleteSubscription(subscriptionId, requestId, correlationId, cancellationToken).GetRawResponse();
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("MyTest.ListAvailablePlans");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("MyTest.ActivateSubscription");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<Subscription> ListSubscriptionsAsync(string continuationToken = null, Guid? requestId = null, Guid? correlationId = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("MyTest.ListSubscriptions");
                scope.Start();
                try
                {
