...
namespace AnomalyDetector.Models
{
    ...
    internal partial class AzureEventHubsDataFeed : DataFeedDetail
    {
        ...
        internal AzureEventHubsDataFeed(string dataFeedName, Granularity granularityName, IEnumerable<Metric> metrics, IEnumerable<Dimension> dimension, DateTimeOffset dataStartFrom, AzureEventHubsParameter dataSourceParameter) : base(dataFeedName, granularityName, metrics, dimension, dataStartFrom)
        {
            ...
            DataSourceType = new DataSourceType("AzureEventHubsDataFeed");
        }
