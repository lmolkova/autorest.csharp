...
namespace AnomalyDetector.Models
{
    ...
    internal partial class MySqlDataFeed : DataFeedDetail
    {
        ...
        internal MySqlDataFeed(string dataFeedName, Granularity granularityName, IEnumerable<Metric> metrics, IEnumerable<Dimension> dimension, DateTimeOffset dataStartFrom, SqlSourceParameter dataSourceParameter) : base(dataFeedName, granularityName, metrics, dimension, dataStartFrom)
        {
            ...
            DataSourceType = new DataSourceType("MySqlDataFeed");
        }
