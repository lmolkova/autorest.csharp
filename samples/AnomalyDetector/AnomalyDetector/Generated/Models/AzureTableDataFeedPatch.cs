...
namespace AnomalyDetector.Models
{
    ...
    internal partial class AzureTableDataFeedPatch : DataFeedDetailPatch
    {
        ...
        internal AzureTableDataFeedPatch(DataSourceType dataSourceType, string dataFeedName, string dataFeedDescription, DateTimeOffset? dataStartFrom, string timestampColumn, long? startOffsetInSeconds, int? maxConcurrency, long? minRetryIntervalInSeconds, long? stopRetryAfterInSeconds, NeedRollupEnum? needRollup, RollUpMethod? rollUpMethod, string rollUpColumns, string allUpIdentification, FillMissingPointType? fillMissingPointForAd, double? fillMissingPointForAdValue, ViewMode? viewMode, IReadOnlyList<string> admins, IReadOnlyList<string> viewers, EntityStatus? status, string actionLinkTemplate, AzureTableParameter dataSourceParameter) : base(dataSourceType, dataFeedName, dataFeedDescription, dataStartFrom, timestampColumn, startOffsetInSeconds, maxConcurrency, minRetryIntervalInSeconds, stopRetryAfterInSeconds, needRollup, rollUpMethod, rollUpColumns, allUpIdentification, fillMissingPointForAd, fillMissingPointForAdValue, viewMode, admins, viewers, status, actionLinkTemplate)
        {
