...
namespace AnomalyDetector.Models
{
    ...
    internal partial class MongoDBDataFeedPatch : DataFeedDetailPatch
    {
        ...
        {
            DataSourceType = new DataSourceType("MongoDBDataFeedPatch");
        }
