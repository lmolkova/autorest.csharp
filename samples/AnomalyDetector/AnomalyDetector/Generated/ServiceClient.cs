...
namespace AnomalyDetector
{
    ...
    public partial class ServiceClient
    {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ServiceClient.EntireDetect");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ServiceClient.LastDetect");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ServiceClient.ChangePointDetect");
            scope.Start();
            try
            {
