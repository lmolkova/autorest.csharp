...
namespace Azure.ResourceManager.DeviceUpdate
{
    ...
    public partial class AccountsCreateOperation : Operation<Account>, IOperationSource<Account>
    {
        ...
        /// <summary> Initializes a new instance of AccountsCreateOperation for mocking. </summary>
        protected AccountsCreateOperation()
        {
        }

        internal AccountsCreateOperation(ResourceOperationsBase operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<Account>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "AccountsCreateOperation");
