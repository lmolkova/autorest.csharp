...
namespace Azure.ResourceManager.DeviceUpdate
{
    ...
    public partial class AccountsUpdateOperation : Operation<Account>, IOperationSource<Account>
    {
        ...
        /// <summary> Initializes a new instance of AccountsUpdateOperation for mocking. </summary>
        protected AccountsUpdateOperation()
        {
        }

        internal AccountsUpdateOperation(ResourceOperationsBase operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<Account>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "AccountsUpdateOperation");
