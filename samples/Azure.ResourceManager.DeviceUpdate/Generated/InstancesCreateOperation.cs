...
namespace Azure.ResourceManager.DeviceUpdate
{
    ...
    public partial class InstancesCreateOperation : Operation<Instance>, IOperationSource<Instance>
    {
        ...
        /// <summary> Initializes a new instance of InstancesCreateOperation for mocking. </summary>
        protected InstancesCreateOperation()
        {
        }

        internal InstancesCreateOperation(ResourceOperationsBase operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<Instance>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "InstancesCreateOperation");
