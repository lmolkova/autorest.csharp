...
namespace CognitiveServices.TextAnalytics
{
    ...
    public partial class ServiceCancelHealthJobOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;
        internal ServiceCancelHealthJobOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ServiceCancelHealthJobOperation");
        }
        /// <inheritdoc />
