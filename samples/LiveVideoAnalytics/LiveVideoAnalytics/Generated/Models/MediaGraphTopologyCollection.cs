...
namespace LiveVideoAnalytics.Models
{
    ...
    public partial class MediaGraphTopologyCollection
    {
        ...
        internal MediaGraphTopologyCollection()
        {
        ...
        internal MediaGraphTopologyCollection(IReadOnlyList<MediaGraphTopology> value, string continuationToken)
        {
            Value = value;
        ...
        /// <summary> Collection of graph topologies. </summary>
        public IReadOnlyList<MediaGraphTopology> Value { get; }
