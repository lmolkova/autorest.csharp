...
namespace DataProtection.Models
{
    ...
    public partial class FailedOrCancelledStartProtectionStatus : StartProtectionStatus
    {
        ...
        internal FailedOrCancelledStartProtectionStatus()
        {
        }
        ...
        internal FailedOrCancelledStartProtectionStatus(IReadOnlyDictionary<string, string> additionalProperties, string telemetryData, int? retryAfterOnRetryableErrorInSeconds, Error error) : base(additionalProperties, telemetryData, retryAfterOnRetryableErrorInSeconds)
        {
            Error = error;
        }
