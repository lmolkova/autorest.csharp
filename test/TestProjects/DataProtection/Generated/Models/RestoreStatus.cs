...
namespace DataProtection.Models
{
    ...
    public partial class RestoreStatus : BaseStatus
    {
        ...
        internal RestoreStatus(IReadOnlyDictionary<string, string> additionalProperties, string telemetryData, int? retryAfterOnRetryableErrorInSeconds, string loopBackContext) : base(additionalProperties, telemetryData, retryAfterOnRetryableErrorInSeconds)
        {
