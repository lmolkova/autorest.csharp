...
namespace DataProtection.Models
{
    ...
    public partial class FailedOrCancelledValidateForRestoreStatus : ValidateForRestoreStatus
    {
        ...
        internal FailedOrCancelledValidateForRestoreStatus()
        {
        }
        ...
        internal FailedOrCancelledValidateForRestoreStatus(IReadOnlyDictionary<string, string> additionalProperties, string telemetryData, int? retryAfterOnRetryableErrorInSeconds, string loopBackContext, Error error) : base(additionalProperties, telemetryData, retryAfterOnRetryableErrorInSeconds, loopBackContext)
        {
            Error = error;
        }
