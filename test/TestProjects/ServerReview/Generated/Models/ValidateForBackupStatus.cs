...
namespace ServerReview.Models
{
    ...
    public partial class ValidateForBackupStatus : BaseStatus
    {
        ...
        internal ValidateForBackupStatus()
        {
        }
        ...
        internal ValidateForBackupStatus(IReadOnlyDictionary<string, string> additionalProperties, string telemetryData, int? retryAfterOnRetryableErrorInSeconds, string loopBackContext) : base(additionalProperties, telemetryData, retryAfterOnRetryableErrorInSeconds)
        {
