...
namespace ServerReview.Models
{
    ...
    public partial class BackupStatus : BaseStatus
    {
        ...
        internal BackupStatus(IReadOnlyDictionary<string, string> additionalProperties, string telemetryData, int? retryAfterOnRetryableErrorInSeconds, string loopBackContext) : base(additionalProperties, telemetryData, retryAfterOnRetryableErrorInSeconds)
        {
