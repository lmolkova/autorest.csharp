...
namespace Microsoft.DelegatedNetwork
{
    ...
    public partial class OrchestratorInstanceServiceDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of OrchestratorInstanceServiceDeleteOperation for mocking. </summary>
        protected OrchestratorInstanceServiceDeleteOperation()
        {
        }

        internal OrchestratorInstanceServiceDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "OrchestratorInstanceServiceDeleteOperation");
        }
        /// <inheritdoc />
